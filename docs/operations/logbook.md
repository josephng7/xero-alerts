...
### 2026-05-04_12:50 +08:00 — Ops datetime Asia/Shanghai (+08:00) (PR split 2/3)
...
### 2026-05-05_12:15 +08:00 — QStash publish URL + Xero Accounting API tenant header (PRs #23–#25)
...
### 2026-05-05_13:10 +08:00 — OpenSpec queued for post–live-demo (planning only, no implementation commit)
...
### 2026-05-08_12:30 +08:00 — pnpm audit: postcss + esbuild transitives (Dependabot-aligned)
